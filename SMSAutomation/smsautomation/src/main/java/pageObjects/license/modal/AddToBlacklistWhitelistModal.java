...
public class AddToBlacklistWhitelistModal extends BasePage {

	public AddToBlacklistWhitelistModal() throws IOException {
		super();
	}
	
	public @FindBy(xpath = "//h3[@class=\"modal-title\" and text()=\"Add to Whitelist\"]") WebElement mod_Add_To_Whitelist_Title;
	public @FindBy(xpath = "//h3[@class=\"modal-title\" and text()=\"Add to Blacklist\"]") WebElement mod_Add_To_Blacklist_Title;
