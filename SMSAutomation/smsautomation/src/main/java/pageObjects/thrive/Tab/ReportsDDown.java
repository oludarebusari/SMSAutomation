...
public class ReportsDDown extends BasePage {
	...
	//Page methods
	public ReportsDDown clickResellerReportOpt() throws Exception {
		waitAndClickElement(opt_Reseller_Report);
		return new ReportsDDown();
	}
	
	public ReportsDDown clickTerritoryReportOpt() throws Exception {
		waitAndClickElement(opt_Territory_Report);
		return new ReportsDDown();
	}
	
	public ReportsDDown clickStreamsStatusReportOpt() throws Exception {
		waitAndClickElement(opt_Streams_Status_Report);
		return new ReportsDDown();
	}
	
	public ReportsDDown clickSSMBGStatusReportOpt() throws Exception {
		waitAndClickElement(opt_SSMBG_Status_Report);
		return new ReportsDDown();
	}
