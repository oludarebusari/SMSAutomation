...
public class CreateOrderPage extends BasePage {
	...
	public CreateOrderPage() throws IOException {
		super();
	}
	...
	public @FindBy(xpath = "//div[@class=\"selectize-dropdown-content\"]") WebElement contentContainer;
	public WebElement orderTypeOption (String option) {
		return contentContainer.findElement(By.xpath("//div[text()=\'" + option + "']"));
	}
	...
	public @FindBy(xpath = "//div[5]/div[1]//tr[1]/th[3]/i") WebElement btn_DueDateNextMonth;
	public @FindBy(xpath = "//textarea[@id=\"create_work_order_workOrderNotes_note\"]") WebElement txtArea_Notes;
	public @FindBy(xpath = "//div[contains(@class, \"form-group\") and ./label[normalize-space()=\"Verticals\"]]//div[contains(@class, \"selectize-input\")]") WebElement verticalsDDown;
...
//	Calendar day selection option
	...
	public WebElement calendarDay(String day) {
		return par_CalendarElement.findElement(By.xpath("//div[5]/div[1]//tr[5]/td[" + day + "]"));
	}
	
	public String getORDERTYPEERRORMSGLOCATOR() {
		return "//div[contains(@class, \"has-error\") and ./label[normalize-space()=\"Business Name\"]]//small[@class=\"help-block\"]";
	}
	
	public String getAPPOITNMENTERRORMSGLOCATOR() {
		return "//div[contains(@class, \"has-error\") and ./label[normalize-space()=\"Business Name\"]]//small[@class=\"help-block\"]";
	}
	
	public String getDUEDATEERRORMSGLOCATOR() {
		return "//div[contains(@class, \"has-error\") and ./label[normalize-space()=\"Business Name\"]]//small[@class=\"help-block\"]";
	}
	
	public String getVERTICALSERRORMSGLOCATOR() {
		return "//div[contains(@class, \"has-error\") and ./label[normalize-space()=\"Business Name\"]]//small[@class=\"help-block\"]";
	}
