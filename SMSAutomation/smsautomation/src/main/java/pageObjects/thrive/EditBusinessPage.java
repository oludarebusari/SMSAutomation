...
public class EditBusinessPage extends BasePage {
	...
	public @FindBy(xpath = "//input[@id=\"company_licensee_merchant_type_singleCompanyAddress_address\"]") WebElement txt_Address;
	...
	public @FindBy(xpath = "//button[@type=\"submit\" and text()[normalize-space()=\"Save Business\"] or @id=\"submit-btn\"]") WebElement btn_SaveBusiness;
	...
	public @FindBy(xpath = "//label[contains(@class, \"toggle-on\") and text()=\"A previously purchased domain\"]") WebElement tog_previouslyPurchasedDomain;
	public @FindBy(xpath = "//label[contains(@class, \"toggle-off\") and text()=\"A Subdomain\"]") WebElement tog_subDomain;
	...
	/*
	 * public WebElement businessCategoryOpt(String option) { return
	 * par_BusinessCategory.findElement(By.
	...
	public @FindBy(xpath = "//div[@class=\"form-group\"]") WebElement parent;
	public WebElement countryStateDDownOption (String name) {
		return parent.findElement(By.xpath("//option[@selected=\"selected\" and text()=\'" + name + "']"));
	}
