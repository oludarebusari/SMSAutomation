...
public class EditAlertModal extends BasePage {

	public EditAlertModal() throws IOException {
		super();
	}

	public @FindBy(xpath = "//h4[@class=\"modal-title\" and text()=\"Edit Alert\"]") WebElement mod_Title;
	...
	public @FindBy(xpath = "//button[contains(@class, \"submit-alerts\")]") WebElement btn_SaveAlert;
}
