...
Feature: Sub menu under "Experience" tab for Business users
  ...
  @Verify-Business-user-is-able-to-navigate-to-Experience->Pages @RegressionTest
  ...
  @Verify-Business-user-is-able-to-navigate-to-Experience->Captivate @RegressionTest 
  ...
  @Verify-Business-user-is-able-to-navigate-to-Experience->Streams @RegressionTest
