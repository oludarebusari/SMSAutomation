...
Feature: [SMSM-916] Upsell Item name doesn't show up on the upsell screen
  ...
  @[SMSM-916] @Verify-that-user-can-cancel-the-update-of-"Upsell-Screen"-from-Advanced-Settings-of-a-selected-campaign 
  ...
  @[SMSM-916] @Verify-that-user-can-save-the-settings-of-an-updated-"Upsell-Screen"-from-Advanced-Settings-of-a-selected-campaign
