...
public class ViewAndEditAccountResourcesUnderMyAccountInMerchantPortal extends DriverFactory {
	...
	public void purchase_History_window_pops_up_and_user_can_view_all_Purchase_history() {
	 
	}

	@When("User clicks on the page drop down count to change the number of records per page")
	public void user_clicks_on_the_page_drop_down_count_to_change_the_number_of_records_per_page() {
	
	}

	@Then("The list of page sizes that can be selected is displayed")
	public void the_list_of_page_sizes_that_can_be_selected_is_displayed() {
	  
	}

	@When("User selects a number from the list")
	public void user_selects_a_number_from_the_list() {
